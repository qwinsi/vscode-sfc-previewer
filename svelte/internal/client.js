/*
 Generated with:
  npx esbuild node_modules/svelte/src/internal/client/index.js --bundle --outfile=svelte/internal/client.js --format=esm
 And added `export` on `function mount`
 */
...
function proxy(value) {
  ...
  var version = state(0);
  var stack2 = dev_fallback_default && tracing_mode_flag ? get_stack("created at") : null;
...
function template_effect(fn, sync = [], async2 = [], blockers = [], defer = false) {
...
export function mount(component2, options) {
  ...
  eager_effect(() => {
    ...
    untrack(() => {
      if (show_stack) {
        inspector(...snap);
        if (!initial) {
          const stack2 = get_stack("$inspect(...)");
          if (stack2) {
